...
|---|-------|----------|--------------|-------------|
| 01 | **First Light** — Rendering the Andromeda Galaxy from raw photon data | [📓 Open](./episode-01-first-light/render_andromeda_from_nasa_data.ipynb) | FITS files, DSS survey, contrast stretching, astropy | NASA SkyView / DSS |
